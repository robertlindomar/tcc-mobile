...
import { processarNfce } from "@/features/nfce/servicoNfce";
...
export default function TelaLerNfce() {
    if (Platform.OS === "web") {
        return <FallbackWeb />;
    }
...
function FallbackWeb() {
    ...
    async function enviar() {
        ...
        setErro(null);
        try {
            const resposta = await processarNfce({ payloadQr: payload });
        ...
        <View style={estilos.conteudoWeb}>
            <View style={estilos.avisoWeb}>
                ...
                <Text style={estilos.textoAvisoWeb}>
                    No navegador, cole o conteúdo do QR da nota fiscal. Em demo use a chave da
                    fixture ou URI tcc://nfce-demo?…
                </Text>
            </View>
